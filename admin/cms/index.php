...
if(isset($id)){
    ...
    if($exe){
        ...
        header('Location: ./index.php?tag=listProducts');
    }
}
...
<header class="px-4 py-2 shadow dark:bg-gray-800">
  <div class="flex justify-between">
    <div class="flex items-center">
      <button data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 mr-4 ml-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" onclick="toggleSidebar()">
        <span class="sr-only">Open sidebar</span>
        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
        </svg>
      </button>
      <button data-search class="p-4 md:hidden focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700" type="button">
      ...
      <div data-search-form class="relative mr-3 hidden md:inline-block">
        <div class="text-gray-500 dark:text-gray-400">
          <!-- 05.902 476.472L386.574 357.144c-8.131-8.131-21.299-8.131-29.43 0-8.131 8.124-8.131 21.306 0 29.43l119.328 119.328A20.74 20.74 0 00491.187 512a20.754 20.754 0 0014.715-6.098c8.131-8.124 8.131-21.306 0-29.43z" /></svg> -->
        </div>
    ...
    <div class="flex items-center">
      <button data-messages class="p-3 mr-2 focus:outline-none hover:bg-gray-200 hover:rounded-md dark:hover:bg-gray-700" type="button">
        <svg class="fill-current w-5 dark:text-gray-400" viewBox="0 0 512 512">
      ...
      <button data-notifications class="p-3 mr-3 focus:outline-none hover:bg-gray-200 hover:rounded-md dark:hover:bg-gray-700" type="button">
        <svg class="fill-current w-5 dark:text-gray-400" viewBox="-21 0 512 512">
      ...
      <button data-dropdown class="flex items-center px-3 py-2 focus:outline-none hover:bg-gray-200 hover:rounded-md dark:hover:bg-gray-700 z-50" type="button" x-data="{ open: false }" @click="open = true" :class="{ 'bg-gray-200 rounded-md dark:bg-gray-700': open }">
        ...
        <span class="ml-4 text-sm hidden md:inline-block dark:text-white">Jessica Smith</span>
        <svg class="fill-current w-3 ml-4 dark:text-gray-400" viewBox="0 0 407.437 407.437">
          <path d="M386.258 91.567l-182.54 181.945L21.179 91.567 0 112.815 203.718 315.87l203.719-203.055z" /></svg>

        <div data-dropdown-items class="text-sm text-left absolute top-0 right-0 mt-16 mr-4 bg-white rounded border border-gray-400 shadow dark:bg-gray-700 dark:border-gray-600" x-show="open" @click.away="open = false">
          <ul>
            <li class="px-4 py-3 border-b hover:bg-gray-200 dark:hover:bg-gray-600"><a href="#" class="dark:text-white">My Profile</a></li>
            <li class="px-4 py-3 border-b hover:bg-gray-200 dark:hover:bg-gray-600"><a href="#" class="dark:text-white">Settings</a></li>
            <li class="px-4 py-3 hover:bg-gray-200 dark:hover:bg-gray-600"><a href="?op=logout" class="dark:text-white">Log out</a></li>
          </ul>
        </div>
      </button>
    </div>
...
<aside id="default-sidebar" class="hidden fixed top-0 left-0 w-64 h-full bg-gray-800 text-white z-50">
  <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 relative">
      <button data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="absolute right-2 top-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" onclick="toggleSidebar()">
          <span class="sr-only">Open sidebar</span>
          <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
      </svg>
      ...
      <ul class="space-y-2">
          ...
          <li>
              <button type="button" class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap">Custom</span>
                  <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
              </button>
              <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                  <li>
                      <a href="?tag=addmenu" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add menu</a>
                  </li>
                  <li>
                      <a href="?tag=listmenu" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Kanban</a>
                  </li>
                  <li>
          ...
          <li>
              ...
              <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                      <li>
                          <a href="?tag=listProducts" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Products</a>
                      </li>
                      <li>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  button.addEventListener('click', () => {
    ...
    button.classList.toggle('bg-gray-200', !isOpen);
    button.classList.toggle('rounded-md', !isOpen);
  });
  ...
  document.addEventListener('click', (event) => {
    ...
    if (!button.contains(event.target) && !dropdown.contains(event.target)) {
      dropdown.style.display = 'none';
      button.classList.remove('bg-gray-200', 'rounded-md');
    }
  });
});
    ...
    document.addEventListener('DOMContentLoaded', () => {
        // Custom JavaScript to toggle dropdown
