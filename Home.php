  ...
  <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-4">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-8">
        <div class="shrink-0">
          <a href="#" title="" class="">
            <img class="block w-auto h-8 dark:hidden" src="asset/IMG/ICON/apple.png" alt="">
            <img class="hidden w-auto h-8 dark:block" src="asset/IMG/ICON/apple.png" alt="">
          </a>
        </div>
      ...
      <div class="flex items-center lg:space-x-2 relative">
        ...
        <div id="myCartDropdown1" class="hidden z-10 mx-auto max-w-sm space-y-4 overflow-hidden rounded-lg bg-white p-4 antialiased shadow-lg dark:bg-gray-800 absolute top-10 right-30">
    <?php
    ...
    ?>
        <div class="grid grid-cols-2">
            <div>
                <a href="#" class="truncate text-sm font-semibold leading-none text-gray-900 dark:text-white hover:underline"><?=$product['productName']?></a>
                <p class="mt-0.5 truncate text-sm font-normal text-gray-500 dark:text-gray-400"><?=$product['productPrice']?>$</p>
            </div>
            <div class="flex items-center justify-end gap-6">
                <p class="text-sm font-normal leading-none text-gray-500 dark:text-gray-400">Qty: <?=$product['productQty']?></p>
    ...
    ?>
    <a href="checkout.php" class="mb-2 me-2 inline-flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" role="button"> Proceed to Checkout </a>
</div>
        ...
        <div id="userDropdown1" class="hidden z-10 w-56 divide-y divide-gray-100 overflow-hidden overflow-y-auto rounded-lg bg-white antialiased shadow dark:divide-gray-600 dark:bg-gray-700 absolute top-10">
          ...
          <div class="p-2 text-sm font-medium text-gray-900 dark:text-white">
            <a href="?op=logout" title="" class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600"> Sign Out </a>
          </div>
        </div>
...
<section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
    <div class="mx-auto grid max-w-screen-xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
      ...
      <div class="hidden md:col-span-5 md:mt-0 md:flex">
        <img class="dark:hidden object-fit" src="asset/IMG/hero/Hero.png" alt="shopping illustration" />
        <img class="hidden dark:block" src="asset/IMG/hero/Hero.png" alt="shopping illustration" />
      </div>
    </div>
...
<main class="px-10">
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-4">
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
          <img class="p-8 rounded-t-lg" src="https://imgs.search.brave.com/tWjwOcNjFj53fWTGKH2hLyVse0gcz1VUCJxL647DMns/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tLWNk/bi5waG9uZWFyZW5h/LmNvbS9pbWFnZXMv/cmV2aWV3cy8yNjE3/NDEtODAwL2lQaG9u/ZS0xNi1Qcm8tY29s/b3JzLTItLndlYnA" alt="product image" />
      </a>
      <div class="px-5 pb-5">
          <a href="#">
          ...
          <div class="flex items-center justify-between">
              ...
              <a href="?card=add" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
          </div>
  ...
  <script>
   document.addEventListener('DOMContentLoaded', function () {
    ...
    function toggleMobileMenu(buttonId, menuId) {
      const button = document.querySelector(`[data-collapse-toggle="${menuId}"]`);
    ...
    toggleDropdown('myCartDropdownButton1', 'myCartDropdown1');
    toggleDropdown('userDropdownButton1', 'userDropdown1');

    // Initialize mobile menu
    toggleMobileMenu('ecommerce-navbar-menu-1', 'ecommerce-navbar-menu-1');
  });
  </script>
</body>
</html>